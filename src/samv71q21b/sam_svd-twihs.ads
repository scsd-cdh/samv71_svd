...
package SAM_SVD.TWIHS is
   ...
   --  Control Register
   type TWIHS_CR_Register is record
   ...
   for TWIHS_CR_Register use record
   ...
   type MMR_IADRSZSelect is
     (--  No internal device address
      ...
      Val_3_BYTE)
     with Size => 2;
   for MMR_IADRSZSelect use
     (NONE => 0,
      Val_1_BYTE => 1,
      Val_2_BYTE => 2,
      Val_3_BYTE => 3);

   subtype TWIHS_MMR_DADR_Field is HAL.UInt7;

   --  Master Mode Register
   type TWIHS_MMR_Register is record
      --  unspecified
      Reserved_0_7   : HAL.UInt8 := 16#0#;
      --  Internal Device Address Size
      IADRSZ         : MMR_IADRSZSelect := SAM_SVD.TWIHS.NONE;
      --  unspecified
      ...
      --  Device Address
      DADR           : TWIHS_MMR_DADR_Field := 16#0#;
      --  unspecified
   ...
   for TWIHS_MMR_Register use record
   ...
   subtype TWIHS_SMR_MASK_Field is HAL.UInt7;
   subtype TWIHS_SMR_SADR_Field is HAL.UInt7;

   --  Slave Mode Register
   type TWIHS_SMR_Register is record
      ...
      --  Slave Address Mask
      MASK           : TWIHS_SMR_MASK_Field := 16#0#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Slave Address
      SADR           : TWIHS_SMR_SADR_Field := 16#0#;
      --  unspecified
   ...
   for TWIHS_SMR_Register use record
   ...
   subtype TWIHS_IADR_IADR_Field is HAL.UInt24;

   --  Internal Address Register
   type TWIHS_IADR_Register is record
      --  Internal Address
      IADR           : TWIHS_IADR_IADR_Field := 16#0#;
      --  unspecified
   ...
   for TWIHS_IADR_Register use record
      IADR           at 0 range 0 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype TWIHS_CWGR_CLDIV_Field is HAL.UInt8;
   subtype TWIHS_CWGR_CHDIV_Field is HAL.UInt8;
   subtype TWIHS_CWGR_CKDIV_Field is HAL.UInt3;
   subtype TWIHS_CWGR_HOLD_Field is HAL.UInt6;

   --  Clock Waveform Generator Register
   type TWIHS_CWGR_Register is record
      --  Clock Low Divider
      CLDIV          : TWIHS_CWGR_CLDIV_Field := 16#0#;
      --  Clock High Divider
      CHDIV          : TWIHS_CWGR_CHDIV_Field := 16#0#;
      --  Clock Divider
      CKDIV          : TWIHS_CWGR_CKDIV_Field := 16#0#;
      --  unspecified
      Reserved_19_23 : HAL.UInt5 := 16#0#;
      --  TWD Hold Time Versus TWCK Falling
      HOLD           : TWIHS_CWGR_HOLD_Field := 16#0#;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for TWIHS_CWGR_Register use record
   ...
   --  Status Register
   type TWIHS_SR_Register is record
   ...
   for TWIHS_SR_Register use record
   ...
   type TWIHS_IER_Register is record
   ...
   for TWIHS_IER_Register use record
      TXCOMP         at 0 range 0 .. 0;
      RXRDY          at 0 range 1 .. 1;
      TXRDY          at 0 range 2 .. 2;
   ...
   type TWIHS_IDR_Register is record
   ...
   for TWIHS_IDR_Register use record
      TXCOMP         at 0 range 0 .. 0;
      RXRDY          at 0 range 1 .. 1;
      TXRDY          at 0 range 2 .. 2;
      Reserved_3_3   at 0 range 3 .. 3;
   ...
   type TWIHS_IMR_Register is record
   ...
   for TWIHS_IMR_Register use record
      TXCOMP         at 0 range 0 .. 0;
      RXRDY          at 0 range 1 .. 1;
      TXRDY          at 0 range 2 .. 2;
      Reserved_3_3   at 0 range 3 .. 3;
   ...
   subtype TWIHS_RHR_RXDATA_Field is HAL.UInt8;

   --  Receive Holding Register
   type TWIHS_RHR_Register is record
      --  Read-only. Master or Slave Receive Holding Data
      RXDATA        : TWIHS_RHR_RXDATA_Field;
      --  unspecified
   ...
   for TWIHS_RHR_Register use record
      RXDATA        at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   subtype TWIHS_THR_TXDATA_Field is HAL.UInt8;

   --  Transmit Holding Register
   type TWIHS_THR_Register is record
      --  Write-only. Master or Slave Transmit Holding Data
      TXDATA        : TWIHS_THR_TXDATA_Field := 16#0#;
      --  unspecified
   ...
   for TWIHS_THR_Register use record
      TXDATA        at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   subtype TWIHS_SMBTR_PRESC_Field is HAL.UInt4;
   subtype TWIHS_SMBTR_TLOWS_Field is HAL.UInt8;
   subtype TWIHS_SMBTR_TLOWM_Field is HAL.UInt8;
   subtype TWIHS_SMBTR_THMAX_Field is HAL.UInt8;

   --  SMBus Timing Register
   type TWIHS_SMBTR_Register is record
      --  SMBus Clock Prescaler
      PRESC        : TWIHS_SMBTR_PRESC_Field := 16#0#;
      --  unspecified
      Reserved_4_7 : HAL.UInt4 := 16#0#;
      --  Slave Clock Stretch Maximum Cycles
      TLOWS        : TWIHS_SMBTR_TLOWS_Field := 16#0#;
      --  Master Clock Stretch Maximum Cycles
      TLOWM        : TWIHS_SMBTR_TLOWM_Field := 16#0#;
      --  Clock High Maximum Cycles
      THMAX        : TWIHS_SMBTR_THMAX_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for TWIHS_SMBTR_Register use record
   ...
   subtype TWIHS_FILTR_THRES_Field is HAL.UInt3;

   --  Filter Register
   type TWIHS_FILTR_Register is record
      --  RX Digital Filter
      FILT           : Boolean := False;
      --  PAD Filter Enable
      ...
      THRES          : TWIHS_FILTR_THRES_Field := 16#0#;
      --  unspecified
   ...
   for TWIHS_FILTR_Register use record
      FILT           at 0 range 0 .. 0;
   ...
   subtype TWIHS_SWMR_SADR1_Field is HAL.UInt7;
   subtype TWIHS_SWMR_SADR2_Field is HAL.UInt7;
   subtype TWIHS_SWMR_SADR3_Field is HAL.UInt7;
   subtype TWIHS_SWMR_DATAM_Field is HAL.UInt8;

   --  SleepWalking Matching Register
   type TWIHS_SWMR_Register is record
      --  Slave Address 1
      SADR1          : TWIHS_SWMR_SADR1_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Slave Address 2
      SADR2          : TWIHS_SWMR_SADR2_Field := 16#0#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Slave Address 3
      SADR3          : TWIHS_SWMR_SADR3_Field := 16#0#;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  Data Match
      DATAM          : TWIHS_SWMR_DATAM_Field := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for TWIHS_SWMR_Register use record
...
--  WPEN bit.Always reads as 0
   ...
   type TWIHS_WPMR_Register is record
   ...
   for TWIHS_WPMR_Register use record
      WPEN         at 0 range 0 .. 0;
      Reserved_1_7 at 0 range 1 .. 7;
      WPKEY        at 0 range 8 .. 31;
   end record;

   subtype TWIHS_WPSR_WPVSRC_Field is HAL.UInt24;

   --  Write Protection Status Register
   type TWIHS_WPSR_Register is record
      --  Read-only. Write Protection Violation Status
      WPVS         : Boolean;
      --  unspecified
      Reserved_1_7 : HAL.UInt7;
      --  Read-only. Write Protection Violation Source
      WPVSRC       : TWIHS_WPSR_WPVSRC_Field;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;

   for TWIHS_WPSR_Register use record
      WPVS         at 0 range 0 .. 0;
      Reserved_1_7 at 0 range 1 .. 7;
   ...
   type TWIHS_Peripheral is record
      --  Control Register
      CR    : aliased TWIHS_CR_Register;
      --  Master Mode Register
      MMR   : aliased TWIHS_MMR_Register;
      --  Slave Mode Register
      SMR   : aliased TWIHS_SMR_Register;
      --  Internal Address Register
      IADR  : aliased TWIHS_IADR_Register;
      --  Clock Waveform Generator Register
      CWGR  : aliased TWIHS_CWGR_Register;
      --  Status Register
      SR    : aliased TWIHS_SR_Register;
      --  Interrupt Enable Register
      IER   : aliased TWIHS_IER_Register;
      --  Interrupt Disable Register
      IDR   : aliased TWIHS_IDR_Register;
      --  Interrupt Mask Register
      IMR   : aliased TWIHS_IMR_Register;
      --  Receive Holding Register
      RHR   : aliased TWIHS_RHR_Register;
      --  Transmit Holding Register
      THR   : aliased TWIHS_THR_Register;
      --  SMBus Timing Register
      SMBTR : aliased TWIHS_SMBTR_Register;
      --  Filter Register
      FILTR : aliased TWIHS_FILTR_Register;
      --  SleepWalking Matching Register
      SWMR  : aliased TWIHS_SWMR_Register;
      --  Write Protection Mode Register
      WPMR  : aliased TWIHS_WPMR_Register;
      --  Write Protection Status Register
      WPSR  : aliased TWIHS_WPSR_Register;
   end record
     with Volatile;
