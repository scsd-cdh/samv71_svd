...
package SAM_SVD.ISI is
   ...
   type ISI_CFG1_Register is record
      ...
      FULL           : Boolean := False;
      --  Threshold Mask
      THMASK         : CFG1_THMASKSelect := SAM_SVD.ISI.BEATS_4;
      --  unspecified
   ...
   type ISI_CFG2_Register is record
      ...
      --  YCrCb Format Swap Mode
      YCC_SWAP       : CFG2_YCC_SWAPSelect := SAM_SVD.ISI.DEFAULT;
      --  RGB Pixel Mapping Configuration
      RGB_CFG        : CFG2_RGB_CFGSelect := SAM_SVD.ISI.DEFAULT;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type ISI_PDECF_Register is record
      --  Decimation Factor
      DEC_FACTOR    : ISI_PDECF_DEC_FACTOR_Field := 16#0#;
      --  unspecified
   ...
   type ISI_R2Y_SET1_Register is record
      ...
      C3             : ISI_R2Y_SET1_C3_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C4
      C4             : ISI_R2Y_SET1_C4_Field := 16#0#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C5
      C5             : ISI_R2Y_SET1_C5_Field := 16#0#;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
