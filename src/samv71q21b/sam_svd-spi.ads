...
package SAM_SVD.SPI is
   ...
   type MR_PCSSelect is
     (--  Reset value for the field
      ...
      NPCS0)
     with Size => 4;
   for MR_PCSSelect use
     (MR_PCSSelect_Reset => 0,
      NPCS3 => 7,
      NPCS2 => 11,
      NPCS1 => 13,
      NPCS0 => 14);
   ...
   type SPI_MR_Register is record
      --  Master/Slave Mode
      MSTR           : MR_MSTRSelect := SAM_SVD.SPI.SLAVE;
      --  Peripheral Select
      PS             : Boolean := False;
      --  Chip Select Decode
      ...
      --  Peripheral Chip Select
      PCS            : MR_PCSSelect := MR_PCSSelect_Reset;
      --  unspecified
   ...
   type TDR_PCSSelect is
     (--  Reset value for the field
      ...
      NPCS0)
     with Size => 4;
   for TDR_PCSSelect use
     (TDR_PCSSelect_Reset => 0,
      NPCS3 => 7,
      NPCS2 => 11,
      NPCS1 => 13,
      NPCS0 => 14);
   ...
   type SPI_TDR_Register is record
      ...
      PCS            : TDR_PCSSelect := TDR_PCSSelect_Reset;
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      --  Write-only. Last Transfer
      LASTXFER       : Boolean := False;
   ...
   type SPI_CSR_Register is record
      --  Clock Polarity
      CPOL   : CSR_CPOLSelect := SAM_SVD.SPI.IDLE_LOW;
      --  Clock Phase
      NCPHA  : CSR_NCPHASelect := SAM_SVD.SPI.VALID_TRAILING_EDGE;
      --  Chip Select Not Active After Transfer (Ignored if CSAAT = 1)
      CSNAAT : Boolean := False;
      --  Chip Select Active After Transfer
      CSAAT  : Boolean := False;
      --  Bits Per Transfer
      BITS   : CSR_BITSSelect := SAM_SVD.SPI.Val_8_BIT;
