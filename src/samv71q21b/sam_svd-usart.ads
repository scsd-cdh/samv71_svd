...
package SAM_SVD.USART is
   ...
   --  Control Register
   type USART_US_CR_USART_MODE_Register is record
      --  unspecified
   ...
   for USART_US_CR_USART_MODE_Register use record
   ...
   --  Control Register
   type USART_US_CR_SPI_MODE_Register is record
      --  unspecified
      Reserved_0_1   : HAL.UInt2 := 16#0#;
      --  Write-only. Reset Receiver
      RSTRX          : Boolean := False;
   ...
   for USART_US_CR_SPI_MODE_Register use record
      Reserved_0_1   at 0 range 0 .. 1;
      RSTRX          at 0 range 2 .. 2;
      RSTTX          at 0 range 3 .. 3;
      RXEN           at 0 range 4 .. 4;
   ...
   --  Control Register
   type USART_US_CR_LIN_MODE_Register is record
      --  unspecified
      Reserved_0_1   : HAL.UInt2 := 16#0#;
      --  Write-only. Reset Receiver
      RSTRX          : Boolean := False;
   ...
   for USART_US_CR_LIN_MODE_Register use record
      Reserved_0_1   at 0 range 0 .. 1;
      RSTRX          at 0 range 2 .. 2;
      RSTTX          at 0 range 3 .. 3;
      RXEN           at 0 range 4 .. 4;
   ...
   type US_MR_USART_MODE_USART_MODESelect is
     (--  Normal mode
      NORMAL,
      --  RS485
      RS485,
      ...
      SPI_SLAVE)
     with Size => 4;
   for US_MR_USART_MODE_USART_MODESelect use
     (NORMAL => 0,
      RS485 => 1,
      HW_HANDSHAKING => 2,
      MODEM => 3,
   ...
   --  Clock Selection
   type US_MR_USART_MODE_USCLKSSelect is
...
--  1), the CD field must be greater than 1.
      ...
      SCK)
     with Size => 2;
   for US_MR_USART_MODE_USCLKSSelect use
     (MCK => 0,
      DIV => 1,
      PCK => 2,
      SCK => 3);
   ...
   --  Character Length
   type US_MR_USART_MODE_CHRLSelect is
     (--  Character length is 5 bits
      ...
      Val_8_BIT)
     with Size => 2;
   for US_MR_USART_MODE_CHRLSelect use
     (Val_5_BIT => 0,
      Val_6_BIT => 1,
      Val_7_BIT => 2,
      Val_8_BIT => 3);
   ...
   --  Parity Type
   type US_MR_USART_MODE_PARSelect is
     (--  Even parity
      EVEN,
      --  Odd parity
      ODD,
      ...
      MULTIDROP)
     with Size => 3;
   for US_MR_USART_MODE_PARSelect use
     (EVEN => 0,
      ODD => 1,
      SPACE => 2,
      MARK => 3,
   ...
   --  Number of Stop Bits
   type US_MR_USART_MODE_NBSTOPSelect is
     (--  1 stop bit
      Val_1_BIT,
      ...
      Val_2_BIT)
     with Size => 2;
   for US_MR_USART_MODE_NBSTOPSelect use
     (Val_1_BIT => 0,
      Val_1_5_BIT => 1,
      Val_2_BIT => 2);

   --  Channel Mode
   type US_MR_USART_MODE_CHMODESelect is
     (--  Normal mode
      NORMAL,
      ...
      REMOTE_LOOPBACK)
     with Size => 2;
   for US_MR_USART_MODE_CHMODESelect use
     (NORMAL => 0,
      AUTOMATIC => 1,
      LOCAL_LOOPBACK => 2,
      REMOTE_LOOPBACK => 3);

   subtype USART_US_MR_USART_MODE_MAX_ITERATION_Field is HAL.UInt3;

   --  Mode Register
   type USART_US_MR_USART_MODE_Register is record
      --  USART Mode of Operation
      USART_MODE     : US_MR_USART_MODE_USART_MODESelect :=
                        SAM_SVD.USART.NORMAL;
      --  Clock Selection
      USCLKS         : US_MR_USART_MODE_USCLKSSelect := SAM_SVD.USART.MCK;
      --  Character Length
      CHRL           : US_MR_USART_MODE_CHRLSelect := SAM_SVD.USART.Val_5_BIT;
      --  Synchronous Mode Select
      SYNC           : Boolean := False;
      --  Parity Type
      PAR            : US_MR_USART_MODE_PARSelect := SAM_SVD.USART.EVEN;
      --  Number of Stop Bits
      NBSTOP         : US_MR_USART_MODE_NBSTOPSelect :=
                        SAM_SVD.USART.Val_1_BIT;
      --  Channel Mode
      CHMODE         : US_MR_USART_MODE_CHMODESelect := SAM_SVD.USART.NORMAL;
      --  Bit Order
      MSBF           : Boolean := False;
      ...
      MAX_ITERATION  : USART_US_MR_USART_MODE_MAX_ITERATION_Field := 16#0#;
      --  unspecified
   ...
   for USART_US_MR_USART_MODE_Register use record
   ...
   --  USART Mode of Operation
   type US_MR_SPI_MODE_USART_MODESelect is
     (--  Normal mode
      NORMAL,
      --  RS485
      RS485,
      ...
      SPI_SLAVE)
     with Size => 4;
   for US_MR_SPI_MODE_USART_MODESelect use
     (NORMAL => 0,
      RS485 => 1,
      HW_HANDSHAKING => 2,
      MODEM => 3,
   ...
   --  Clock Selection
   type US_MR_SPI_MODE_USCLKSSelect is
     (--  Peripheral clock is selected
      MCK,
      --  Peripheral clock divided (DIV = 8) is selected
      DIV,
...
--  1), the CD field must be greater than 1.
      ...
      SCK)
     with Size => 2;
   for US_MR_SPI_MODE_USCLKSSelect use
     (MCK => 0,
      DIV => 1,
      PCK => 2,
      SCK => 3);
   ...
   --  Character Length
   type US_MR_SPI_MODE_CHRLSelect is
     (--  Character length is 5 bits
      Val_5_BIT,
      --  Character length is 6 bits
      Val_6_BIT,
      ...
      Val_8_BIT)
     with Size => 2;
   for US_MR_SPI_MODE_CHRLSelect use
     (Val_5_BIT => 0,
      Val_6_BIT => 1,
      Val_7_BIT => 2,
      Val_8_BIT => 3);
   ...
   --  Mode Register
   type USART_US_MR_SPI_MODE_Register is record
      --  USART Mode of Operation
      USART_MODE     : US_MR_SPI_MODE_USART_MODESelect :=
                        SAM_SVD.USART.NORMAL;
      --  Clock Selection
      USCLKS         : US_MR_SPI_MODE_USCLKSSelect := SAM_SVD.USART.MCK;
      --  Character Length
      CHRL           : US_MR_SPI_MODE_CHRLSelect := SAM_SVD.USART.Val_5_BIT;
      --  SPI Clock Phase
      CPHA           : Boolean := False;
      --  unspecified
   ...
   for USART_US_MR_SPI_MODE_Register use record
      USART_MODE     at 0 range 0 .. 3;
      USCLKS         at 0 range 4 .. 5;
      CHRL           at 0 range 6 .. 7;
      CPHA           at 0 range 8 .. 8;
   ...
   type USART_US_IER_USART_MODE_Register is record
   ...
   for USART_US_IER_USART_MODE_Register use record
   ...
   --  Interrupt Enable Register
   type USART_US_IER_SPI_MODE_Register is record
      --  Write-only. RXRDY Interrupt Enable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Enable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IER_SPI_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
   ...
   --  Interrupt Enable Register
   type USART_US_IER_LIN_MODE_Register is record
      --  Write-only. RXRDY Interrupt Enable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Enable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IER_LIN_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Interrupt Enable Register
   type USART_US_IER_LON_MODE_Register is record
      --  Write-only. RXRDY Interrupt Enable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Enable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IER_LON_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   type USART_US_IDR_USART_MODE_Register is record
   ...
   for USART_US_IDR_USART_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      RXBRK          at 0 range 2 .. 2;
      Reserved_3_4   at 0 range 3 .. 4;
   ...
   --  Interrupt Disable Register
   type USART_US_IDR_SPI_MODE_Register is record
      --  Write-only. RXRDY Interrupt Disable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Disable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IDR_SPI_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Interrupt Disable Register
   type USART_US_IDR_LIN_MODE_Register is record
      --  Write-only. RXRDY Interrupt Disable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Disable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IDR_LIN_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Interrupt Disable Register
   type USART_US_IDR_LON_MODE_Register is record
      --  Write-only. RXRDY Interrupt Disable
      RXRDY          : Boolean := False;
      --  Write-only. TXRDY Interrupt Disable
      TXRDY          : Boolean := False;
   ...
   for USART_US_IDR_LON_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   type USART_US_IMR_USART_MODE_Register is record
   ...
   for USART_US_IMR_USART_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      RXBRK          at 0 range 2 .. 2;
      Reserved_3_4   at 0 range 3 .. 4;
   ...
   --  Interrupt Mask Register
   type USART_US_IMR_SPI_MODE_Register is record
      --  Read-only. RXRDY Interrupt Mask
      RXRDY          : Boolean;
      --  Read-only. TXRDY Interrupt Mask
      TXRDY          : Boolean;
   ...
   for USART_US_IMR_SPI_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Interrupt Mask Register
   type USART_US_IMR_LIN_MODE_Register is record
      --  Read-only. RXRDY Interrupt Mask
      RXRDY          : Boolean;
      --  Read-only. TXRDY Interrupt Mask
      TXRDY          : Boolean;
   ...
   for USART_US_IMR_LIN_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Interrupt Mask Register
   type USART_US_IMR_LON_MODE_Register is record
      --  Read-only. RXRDY Interrupt Mask
      RXRDY          : Boolean;
      --  Read-only. TXRDY Interrupt Mask
      TXRDY          : Boolean;
   ...
   for USART_US_IMR_LON_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   type USART_US_CSR_USART_MODE_Register is record
   ...
   for USART_US_CSR_USART_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      RXBRK          at 0 range 2 .. 2;
      Reserved_3_4   at 0 range 3 .. 4;
   ...
   --  Channel Status Register
   type USART_US_CSR_SPI_MODE_Register is record
      --  Read-only. Receiver Ready (cleared by reading US_RHR)
      RXRDY          : Boolean;
      --  Read-only. Transmitter Ready (cleared by writing US_THR)
      TXRDY          : Boolean;
   ...
   for USART_US_CSR_SPI_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Channel Status Register
   type USART_US_CSR_LIN_MODE_Register is record
      --  Read-only. Receiver Ready (cleared by reading US_RHR)
      RXRDY          : Boolean;
      --  Read-only. Transmitter Ready (cleared by writing US_THR)
      TXRDY          : Boolean;
   ...
   for USART_US_CSR_LIN_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   --  Channel Status Register
   type USART_US_CSR_LON_MODE_Register is record
      --  Read-only. Receiver Ready (cleared by reading US_RHR)
      RXRDY          : Boolean;
      --  Read-only. Transmitter Ready (cleared by writing US_THR)
      TXRDY          : Boolean;
      ...
      --  US_CR.RSTSTA)
      OVRE           : Boolean;
      --  Read-only. LON Short Frame Error
      LSFE           : Boolean;
      --  Read-only. LON CRC Error
      LCRCE          : Boolean;
      --  unspecified
      Reserved_8_8   : HAL.Bit;
      --  Read-only. Transmitter Empty (cleared by writing US_THR)
      ...
      --  unspecified
      Reserved_11_23 : HAL.UInt13;
      --  Read-only. LON Transmission End Flag
      LTXD           : Boolean;
      --  Read-only. LON Collision Detected Flag
      LCOL           : Boolean;
      --  Read-only. LON Frame Early Termination
      LFET           : Boolean;
      --  Read-only. LON Reception End Flag
      LRXD           : Boolean;
      --  Read-only. LON Backlog Overflow Error
      LBLOVFE        : Boolean;
      --  unspecified
      Reserved_29_31 : HAL.UInt3;
   end record
   ...
   for USART_US_CSR_LON_MODE_Register use record
      RXRDY          at 0 range 0 .. 0;
      TXRDY          at 0 range 1 .. 1;
      Reserved_2_4   at 0 range 2 .. 4;
      OVRE           at 0 range 5 .. 5;
   ...
   subtype USART_US_TTGR_USART_MODE_TG_Field is HAL.UInt8;

   --  Transmitter Timeguard Register
   type USART_US_TTGR_USART_MODE_Register is record
      --  Timeguard Value
      TG            : USART_US_TTGR_USART_MODE_TG_Field := 16#0#;
      --  unspecified
   ...
   for USART_US_TTGR_USART_MODE_Register use record
      TG            at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   subtype USART_US_TTGR_LON_MODE_PCYCLE_Field is HAL.UInt24;

   --  Transmitter Timeguard Register
   type USART_US_TTGR_LON_MODE_Register is record
      --  LON PCYCLE Length
      PCYCLE         : USART_US_TTGR_LON_MODE_PCYCLE_Field := 16#0#;
      --  unspecified
   ...
   for USART_US_TTGR_LON_MODE_Register use record
      PCYCLE         at 0 range 0 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype USART_US_FIDI_USART_MODE_FI_DI_RATIO_Field is HAL.UInt16;

   --  FI DI Ratio Register
   type USART_US_FIDI_USART_MODE_Register is record
      --  FI Over DI Ratio Value
      FI_DI_RATIO    : USART_US_FIDI_USART_MODE_FI_DI_RATIO_Field := 16#0#;
      --  unspecified
      Reserved_16_31 : HAL.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for USART_US_FIDI_USART_MODE_Register use record
      FI_DI_RATIO    at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   subtype USART_US_FIDI_LON_MODE_BETA2_Field is HAL.UInt24;

   --  FI DI Ratio Register
   type USART_US_FIDI_LON_MODE_Register is record
      --  LON BETA2 Length
      BETA2          : USART_US_FIDI_LON_MODE_BETA2_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for USART_US_FIDI_LON_MODE_Register use record
...
--  WPEN bit. Always reads as 0.
   ...
   type USART_Peripheral
     (Discriminent : USART0_Disc := USART_MODE)
   is record
      --  Receive Holding Register
      ...
      case Discriminent is
         when USART_MODE =>
            --  Control Register
            US_CR_USART_MODE : aliased USART_US_CR_USART_MODE_Register;
            --  Mode Register
            US_MR_USART_MODE : aliased USART_US_MR_USART_MODE_Register;
            --  Interrupt Enable Register
            US_IER_USART_MODE : aliased USART_US_IER_USART_MODE_Register;
            --  Interrupt Disable Register
            US_IDR_USART_MODE : aliased USART_US_IDR_USART_MODE_Register;
            --  Interrupt Mask Register
            US_IMR_USART_MODE : aliased USART_US_IMR_USART_MODE_Register;
            --  Channel Status Register
            US_CSR_USART_MODE : aliased USART_US_CSR_USART_MODE_Register;
            --  Transmitter Timeguard Register
            US_TTGR_USART_MODE : aliased USART_US_TTGR_USART_MODE_Register;
            --  FI DI Ratio Register
            US_FIDI_USART_MODE : aliased USART_US_FIDI_USART_MODE_Register;
         when SPI_MODE =>
            --  Control Register
            US_CR_SPI_MODE : aliased USART_US_CR_SPI_MODE_Register;
            --  Mode Register
            US_MR_SPI_MODE : aliased USART_US_MR_SPI_MODE_Register;
            --  Interrupt Enable Register
            US_IER_SPI_MODE : aliased USART_US_IER_SPI_MODE_Register;
            --  Interrupt Disable Register
            US_IDR_SPI_MODE : aliased USART_US_IDR_SPI_MODE_Register;
            --  Interrupt Mask Register
            US_IMR_SPI_MODE : aliased USART_US_IMR_SPI_MODE_Register;
            --  Channel Status Register
            US_CSR_SPI_MODE : aliased USART_US_CSR_SPI_MODE_Register;
         when LIN_MODE =>
            --  Control Register
            US_CR_LIN_MODE : aliased USART_US_CR_LIN_MODE_Register;
            --  Interrupt Enable Register
            US_IER_LIN_MODE : aliased USART_US_IER_LIN_MODE_Register;
            --  Interrupt Disable Register
            US_IDR_LIN_MODE : aliased USART_US_IDR_LIN_MODE_Register;
            --  Interrupt Mask Register
            US_IMR_LIN_MODE : aliased USART_US_IMR_LIN_MODE_Register;
            --  Channel Status Register
            US_CSR_LIN_MODE : aliased USART_US_CSR_LIN_MODE_Register;
         when LON_MODE =>
            --  Interrupt Enable Register
            US_IER_LON_MODE : aliased USART_US_IER_LON_MODE_Register;
            --  Interrupt Disable Register
            US_IDR_LON_MODE : aliased USART_US_IDR_LON_MODE_Register;
            --  Interrupt Mask Register
            US_IMR_LON_MODE : aliased USART_US_IMR_LON_MODE_Register;
            --  Channel Status Register
            US_CSR_LON_MODE : aliased USART_US_CSR_LON_MODE_Register;
            --  Transmitter Timeguard Register
            US_TTGR_LON_MODE : aliased USART_US_TTGR_LON_MODE_Register;
            --  FI DI Ratio Register
            US_FIDI_LON_MODE : aliased USART_US_FIDI_LON_MODE_Register;
      end case;
   end record
   ...
   for USART_Peripheral use record
      ...
      US_CR_USART_MODE   at 16#0# range 0 .. 31;
      US_MR_USART_MODE   at 16#4# range 0 .. 31;
      US_IER_USART_MODE  at 16#8# range 0 .. 31;
      US_IDR_USART_MODE  at 16#C# range 0 .. 31;
      US_IMR_USART_MODE  at 16#10# range 0 .. 31;
      US_CSR_USART_MODE  at 16#14# range 0 .. 31;
      US_TTGR_USART_MODE at 16#28# range 0 .. 31;
      US_FIDI_USART_MODE at 16#40# range 0 .. 31;
      US_CR_SPI_MODE     at 16#0# range 0 .. 31;
      US_MR_SPI_MODE     at 16#4# range 0 .. 31;
      US_IER_SPI_MODE    at 16#8# range 0 .. 31;
      US_IDR_SPI_MODE    at 16#C# range 0 .. 31;
      US_IMR_SPI_MODE    at 16#10# range 0 .. 31;
      US_CSR_SPI_MODE    at 16#14# range 0 .. 31;
      US_CR_LIN_MODE     at 16#0# range 0 .. 31;
      US_IER_LIN_MODE    at 16#8# range 0 .. 31;
      US_IDR_LIN_MODE    at 16#C# range 0 .. 31;
      US_IMR_LIN_MODE    at 16#10# range 0 .. 31;
      US_CSR_LIN_MODE    at 16#14# range 0 .. 31;
      US_IER_LON_MODE    at 16#8# range 0 .. 31;
      US_IDR_LON_MODE    at 16#C# range 0 .. 31;
      US_IMR_LON_MODE    at 16#10# range 0 .. 31;
      US_CSR_LON_MODE    at 16#14# range 0 .. 31;
      US_TTGR_LON_MODE   at 16#28# range 0 .. 31;
      US_FIDI_LON_MODE   at 16#40# range 0 .. 31;
   end record;
