...
--  reads as 0.
   ...
   type PMC_SR_Register is record
      ...
      OSCSELS        : Boolean;
      --  Read-only. Programmable Clock Ready 0 Status
   ...
   type PMC_IMR_PCKRDY_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type PMC_FSMR_Register is record
      ...
      LPM            : Boolean := False;
      --  Flash Low-power Mode
      FLPM           : FSMR_FLPMSelect := SAM_SVD.PMC.FLASH_STANDBY;
...
--  WPEN bit. Always reads as 0.
   ...
   type PMC_Peripheral is record
      ...
      --  Peripheral Clock Enable Register 0
      PCER0      : aliased PMC_PCER0_Register;
      --  Peripheral Clock Disable Register 0
      PCDR0      : aliased PMC_PCDR0_Register;
      --  Peripheral Clock Status Register 0
      PCSR0      : aliased PMC_PCSR0_Register;
      --  UTMI Clock Register
      ...
      --  Fast Startup Mode Register
      FSMR       : aliased PMC_FSMR_Register;
      --  Fast Startup Polarity Register
      FSPR       : aliased PMC_FSPR_Register;
      --  Fault Output Clear Register
      ...
      --  Peripheral Clock Enable Register 1
      PCER1      : aliased PMC_PCER1_Register;
      --  Peripheral Clock Disable Register 1
      PCDR1      : aliased PMC_PCDR1_Register;
      --  Peripheral Clock Status Register 1
      PCSR1      : aliased PMC_PCSR1_Register;
      --  Peripheral Control Register
      PCR        : aliased PMC_PCR_Register;
      --  Oscillator Calibration Register
      OCR        : aliased PMC_OCR_Register;
      --  SleepWalking Enable Register 0
      SLPWK_ER0  : aliased PMC_SLPWK_ER0_Register;
      --  SleepWalking Disable Register 0
      SLPWK_DR0  : aliased PMC_SLPWK_DR0_Register;
      --  SleepWalking Status Register 0
      SLPWK_SR0  : aliased PMC_SLPWK_SR0_Register;
      --  SleepWalking Activity Status Register 0
      SLPWK_ASR0 : aliased PMC_SLPWK_ASR0_Register;
      --  PLL Maximum Multiplier Value Register
      PMMR       : aliased PMC_PMMR_Register;
      --  SleepWalking Enable Register 1
      SLPWK_ER1  : aliased PMC_SLPWK_ER1_Register;
      --  SleepWalking Disable Register 1
      SLPWK_DR1  : aliased PMC_SLPWK_DR1_Register;
      --  SleepWalking Status Register 1
      SLPWK_SR1  : aliased PMC_SLPWK_SR1_Register;
      --  SleepWalking Activity Status Register 1
      SLPWK_ASR1 : aliased PMC_SLPWK_ASR1_Register;
      --  SleepWalking Activity In Progress Register
      SLPWK_AIPR : aliased PMC_SLPWK_AIPR_Register;
   end record
     with Volatile;
   ...
   for PMC_Peripheral use record
      ...
      PCER0      at 16#10# range 0 .. 31;
      PCDR0      at 16#14# range 0 .. 31;
      PCSR0      at 16#18# range 0 .. 31;
      ...
      USB        at 16#38# range 0 .. 31;
      PCK        at 16#40# range 0 .. 255;
      IER        at 16#60# range 0 .. 31;
      IDR        at 16#64# range 0 .. 31;
      SR         at 16#68# range 0 .. 31;
      IMR        at 16#6C# range 0 .. 31;
      FSMR       at 16#70# range 0 .. 31;
      FSPR       at 16#74# range 0 .. 31;
      FOCR       at 16#78# range 0 .. 31;
      WPMR       at 16#E4# range 0 .. 31;
      WPSR       at 16#E8# range 0 .. 31;
      PCER1      at 16#100# range 0 .. 31;
      PCDR1      at 16#104# range 0 .. 31;
      PCSR1      at 16#108# range 0 .. 31;
      PCR        at 16#10C# range 0 .. 31;
      OCR        at 16#110# range 0 .. 31;
      SLPWK_ER0  at 16#114# range 0 .. 31;
      SLPWK_DR0  at 16#118# range 0 .. 31;
      SLPWK_SR0  at 16#11C# range 0 .. 31;
      SLPWK_ASR0 at 16#120# range 0 .. 31;
      PMMR       at 16#130# range 0 .. 31;
      SLPWK_ER1  at 16#134# range 0 .. 31;
      SLPWK_DR1  at 16#138# range 0 .. 31;
      SLPWK_SR1  at 16#13C# range 0 .. 31;
      SLPWK_ASR1 at 16#140# range 0 .. 31;
      SLPWK_AIPR at 16#144# range 0 .. 31;
   end record;
