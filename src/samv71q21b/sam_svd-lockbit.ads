...
package SAM_SVD.LOCKBIT is
   ...
   --  Lock Bits Word 0
   type LOCKBIT_WORD0_Register is record
      --  Lock Region 0
   ...
   for LOCKBIT_WORD0_Register use record
   ...
   --  Lock Bits Word 1
   type LOCKBIT_WORD1_Register is record
      --  Lock Region 32
   ...
   for LOCKBIT_WORD1_Register use record
   ...
   --  Lock Bits Word 2
   type LOCKBIT_WORD2_Register is record
      --  Lock Region 64
   ...
   for LOCKBIT_WORD2_Register use record
   ...
   --  Lock Bits Word 3
   type LOCKBIT_WORD3_Register is record
      --  Lock Region 96
   ...
   for LOCKBIT_WORD3_Register use record
   ...
   type LOCKBIT_Peripheral is record
      --  Lock Bits Word 0
      WORD0 : aliased LOCKBIT_WORD0_Register;
      --  Lock Bits Word 1
      WORD1 : aliased LOCKBIT_WORD1_Register;
      --  Lock Bits Word 2
      WORD2 : aliased LOCKBIT_WORD2_Register;
      --  Lock Bits Word 3
      WORD3 : aliased LOCKBIT_WORD3_Register;
   end record
     with Volatile;

   for LOCKBIT_Peripheral use record
      WORD0 at 16#0# range 0 .. 31;
      WORD1 at 16#4# range 0 .. 31;
      WORD2 at 16#8# range 0 .. 31;
      WORD3 at 16#C# range 0 .. 31;
   end record;
